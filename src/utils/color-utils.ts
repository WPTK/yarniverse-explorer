...
const COLOR_GROUPS: ColorGroup[] = [
  { name: 'Reds', colors: ['red', 'crimson', 'maroon', 'burgundy', 'ruby'], hue: 0 },
  { name: 'Pinks', colors: ['pink', 'hotpink', 'magenta', 'fuchsia', 'rose'], hue: 330 },
  { name: 'Purples', colors: ['purple', 'violet', 'lavender', 'lilac', 'indigo'], hue: 270 },
  { name: 'Blues', colors: ['blue', 'navy', 'royalblue', 'skyblue', 'turquoise'], hue: 210 },
  { name: 'Teals', colors: ['teal', 'cyan', 'turquoise'], hue: 180 },
  { name: 'Greens', colors: ['green', 'lime', 'emerald', 'mint', 'olive', 'forest'], hue: 120 },
  { name: 'Browns', colors: ['brown', 'chocolate', 'tan', 'beige', 'coffee'], hue: 30 },
  { name: 'Neutrals', colors: ['white', 'gray', 'grey', 'silver', 'black', 'cream', 'ivory', 'offwhite', 'charcoal', 'taupe'], hue: 0 },
];
